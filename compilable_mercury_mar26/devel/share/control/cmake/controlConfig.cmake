...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/derekroesch/catkin_ws/Compilable Mercury Mar26/src/control)
  set(control_DEVEL_PREFIX /home/derekroesch/catkin_ws/Compilable Mercury Mar26/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/derekroesch/catkin_ws/Compilable Mercury Mar26/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/derekroesch/catkin_ws/Compilable Mercury Mar26/src/control/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;msgs_and_srvs;hw_interface_plugin_dynamixel")
