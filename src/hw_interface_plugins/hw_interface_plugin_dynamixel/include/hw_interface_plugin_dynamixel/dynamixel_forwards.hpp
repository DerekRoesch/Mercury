...
namespace hw_interface_plugin_dynamixel
{
    ...
    //capabilities
        ...
        enum dynamixel_abilities_t {
            ...
            ABILITY_OPERATING_MODE=1<<13, ABILITY_TORQUE_ENABLE=1<<14, ABILITY_PRESENT_CURRENT=1<<15, ABILITY_TORQUE_LIMIT=1<<16,
            ABILITY_GOAL_TORQUE=1<<17, ABILITY_BAUD_RATE=1<<18,
        };
