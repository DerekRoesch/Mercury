...
//Constructs the Dynamixel Classes

/*
 *
 * swap these with boost tupless
 */
//Checks the model compatability
                                                                                ...
                                                                                const std::vector<uint8_t> &servoResponse)
{
    ...
    {
        case 0x0141: //mx-106
            return boost::make_tuple(dynamixel_types::MX, dynamixel_types::MX_106);
        case 0x0136: //MX-64
            return boost::make_tuple(dynamixel_types::MX, dynamixel_types::MX_64);
        case 0x001d: //MX_28 Comm V1 decimal 29
        case 30:     //MX_28 Comm V2
...
//creates an instance of the servo to communicate with
                                                              ...
                                                              dynamixel_types::comm_version_t commVersion)
{
    ...
    {
        case dynamixel_types::MX_106:
            ROS_INFO("Identified Servo as MX_106 based on initial EEPROM Dump");
            return boost::shared_ptr<dynamixel_servo>(new dynamixel_actuators::mx_106(idNum,servoResponse,commVersion));
        ...
        case dynamixel_types::MX_28:
            ...
            return boost::shared_ptr<dynamixel_servo>(new dynamixel_actuators::mx_28(idNum, servoResponse,commVersion));
